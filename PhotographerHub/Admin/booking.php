  ...
  <nav class="navbar navbar-expand-md navbar-dark bg-dark">
    ...
    <div class="collapse navbar-collapse" id="navbarCollapse" style="margin-left: 6%;">
        <div class="navbar-nav">
            ...
            <a href="photographer.php" class="nav-item nav-link">booking</a>
                     ...
                     <table id="photographer_data" class="table table-striped table-bordered">  
                          ...
                          {  
                               ...
                               <tr id='.$row["book_id"].'>  
                                    ...
                                    <td> <input type="button" name="view"  value="Delete" id="'.$row["book_id"].'" class="btn btn-danger btn-xs delete"/> </td>  
